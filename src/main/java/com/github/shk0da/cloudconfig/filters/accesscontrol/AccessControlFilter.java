package com.github.shk0da.cloudconfig.filters.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
    ...
    public AccessControlFilter(RouteLocator routeLocator, CloudConfigProperties cloudConfigProperties) {
    ...
    private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = cloudConfigProperties.getGateway()
