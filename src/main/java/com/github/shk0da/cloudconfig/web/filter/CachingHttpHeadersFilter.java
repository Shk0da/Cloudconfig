package com.github.shk0da.cloudconfig.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(CloudConfigProperties cloudConfigProperties) {
        this.cloudConfigProperties = cloudConfigProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(cloudConfigProperties.getHttp().getCache().getTimeToLiveInDays());
    }
